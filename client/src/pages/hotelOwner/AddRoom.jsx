        ...
        <form>
            ...
            <div className='grid grid-cols-2 sm:flex gap-4 my-2 flex-wrap'>
                {Object.keys(images).map((key) => (
                    <label htmlFor={`roomImage${key}`} key={key}>
                        ...
                        type="file" accept='image/*' id={`roomImage${key}`} hidden/>
                    </label>
                ))}
            </div>
            ...
            <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
                ...
                <div>
                    ...
                    <input onChange={e => setInputs({...inputs, pricePerNight: e.target.value})} value={inputs.pricePerNight}
            ...
            <div className='flex flex-col flex-wrap mt-1 text-gray-400 max-w-sm'>
                {Object.keys(inputs.amenities).map((amenity, index) => (
                    <div key={index}>
                        <input onChange={() => setInputs({...inputs, amenities: {...inputs.amenities, [amenity]: !inputs.amenities[amenity]}})}
            ...
            <button className='bg-primary text-white px-8 rounded mt-8 cursor-pointer'>
                Add Room
            </button>
